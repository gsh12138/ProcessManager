...
namespace ProcessManager
{
    public class BundleConfig
    {
        ...
        public static void RegisterBundles(BundleCollection bundles)
        {
            ...
            bundles.Add(new StyleBundle("~/Content/css/neirong").Include(
                      "~/Content/Neirong.css"
                ));
            bundles.Add(new StyleBundle("~/Content/css/datapicker").Include(
        ...
        public static void RegisterBundles(BundleCollection bundles) {
            ...
            bundles.Add(new StyleBundle("~/css/datapicker").Include(
                        "~/Content/bootstrap-datetimepicker.min.css"
                ));
